...
export type lazyJSXType = React.LazyExoticComponent<
...
const NotesList: lazyJSXType = lazy(
  () => import("./pages/Notes/NotesList.tsx"),
);
...
const CreateNewNote: lazyJSXType = lazy(
  () => import("./pages/Notes/CreateNewNote.tsx"),
);
