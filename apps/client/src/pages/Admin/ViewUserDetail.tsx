...
const ViewUserDetail = ()=> {
    ...
    if(user as resUsersArrayType){
        const created: string = new Date(user.createdAt).toLocaleString('en-US', {day: 'numeric', month: 'long'});
        return (
            <div>
                ...
                <h3>Status: {user.isActive ? <span className={'activeUser'}>Active</span> :
                    <span className={'blockedUser'}>Blocked</span>}</h3>
